			    ...
			    union power_supply_propval *val)
{
	...
	case POWER_SUPPLY_PROP_VOLTAGE_MAX:
		bq24260_i2c_read(charger->client, BQ24260_VOLTAGE, &data);
		val->intval = data;
			    ...
			    const union power_supply_propval *val)
{
	...
	case POWER_SUPPLY_PROP_VOLTAGE_MAX:
		...
		data = bq24260_get_float_voltage_data(val->intval);
		bq24260_set_command(charger->client, BQ24260_VOLTAGE, data);
		data = 0x00;
		bq24260_i2c_read(charger->client, BQ24260_VOLTAGE, &data);
